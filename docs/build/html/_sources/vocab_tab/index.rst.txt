...
.. dropdown:: Event
    ...
    .. dropdown:: EarliestDateCollected
...
.. dropdown:: EventMeasurement
    ...
    .. dropdown:: eventMeasurementValue
...
.. dropdown:: Identification
    ...
    .. dropdown:: identificationAttributes
...
.. dropdown:: Location
    ...
    .. dropdown:: SamplingLocationRemarks

        *status: deprecated*

        Comments or notes about the sampling location.

    .. dropdown:: SamplingLocationID
...
.. dropdown:: MaterialSample
    ...
    .. dropdown:: verbatimLabel
        ...
        *status: superseded*
        ...
        A serialized encoding intended to represent the literal, i.e., character by character, textual content of a label affixed on, near, or explicitly associated with a material entity, free from interpretation, translation, or transliteration.
...
.. dropdown:: Occurrence
    ...
    .. dropdown:: associatedSequences
        ...
        *status: superseded*
        ...
        A list (concatenated and separated) of identifiers (publication, global unique identifier, URI) of genetic sequence information associated with the dwc:Occurrence.
...
.. dropdown:: OccurrenceMeasurement
    ...
    .. dropdown:: occurrenceMeasurementUnit
    ...
    .. dropdown:: occurrenceMeasurementValue
...
.. dropdown:: ResourceRelationship
    ...
    .. dropdown:: relationshipOfResource
        ...
        *status: superseded*
        ...
        The relationship of the subject (identified by resourceID) to the object (identified by relatedResourceID).
...
.. dropdown:: Taxon
    ...
    .. dropdown:: scientificNameRank

        *status: deprecated*

        The taxonomic rank of the most specific name in the scientificName. Recommended best practice is to use a controlled vocabulary.

    .. dropdown:: verbatimScientificNameRank
